(function (factory) {
    ...
    return function Translate() {
        ...
        function translate() {
            ...
            console.log(`https://www.googleapis.com/language/translate/v2?key=AIzaSyBICHvOzCaXjtSLYdC6y5vKnlIptW9dbRY&source=${src().code}&target=${target().code}&q=${encodeURIComponent(input())}`)
